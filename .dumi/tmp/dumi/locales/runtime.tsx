...
import { RawIntlProvider, createIntl, createIntlCache } from '/Users/kam/worker/github/sukee/node_modules/react-intl';
import { useIsomorphicLayoutEffect } from '/Users/kam/worker/github/sukee/node_modules/dumi/dist/client/theme-api/utils.js'
...
const LocalesContainer: FC<{ children: ReactNode }> = (props) => {
  const getIntl = useCallback(() => {
    ...
    localeMessages['$internal.edit.link'] = "https://github.com/kampiu/sukee/edit/master/{filename}";
